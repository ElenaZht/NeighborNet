...
export default function GiveAwayInputForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // const response = await submitGiveaway(formData);
      ...
      setError("Failed to submit giveaway. Please try again.");
                ...
                <div className="form-control w-full">
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center h-64">
                    {formData.imagePreview ? (
                      ...
                      <>
                        <p className="text-gray-500 mb-2">Upload a photo of the item</p>
                        <input 
                          type="file" 
              ...
              <div className="flex flex-col gap-4">
                <div className="form-control w-full">
                  ...
                  <input 
                    ...
                    placeholder="E.g., Teapot, Furniture, Books"
                  />
                </div>
                ...
                <div className="form-control mt-4">
                  ...
                  >
                    {isSubmitting ? 'Posting...' : 'Post Giveaway'}
                  </button>
                </div>
              </div>
            </div>
